    ...
    for i, filename in enumerate(sorted(os.listdir('scenarios_sparse2d/'))):    
        ...
        for i in range(len(params)):
            if filename.endswith('.p'):
                ...
                test = RandomTest('revisited/feb16_rand_eps/6/' + filename, 40, ITER, TRIALS, SAMP,INTIT_TEST)      # (ignore '40'), first parameter is where data/plots are saved within ./comparisons/
