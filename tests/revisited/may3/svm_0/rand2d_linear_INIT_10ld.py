...
if __name__ == '__main__':
    ...
    INIT_TEST = uniform_param.INIT_SAMPLES 
    ITER = uniform_param.ITER
    ...
    for i, filename in enumerate(sorted(os.listdir('scenarios_sparse2d/'))):    
        ...
        for i in range(len(params)):
            if filename.endswith('.p'):
                ...
                test = RandomTest('revisited/may3/0/' + filename, 40, ITER, TRIALS, SAMP,INIT_TEST)      # (ignore '40'), first parameter is where data/plots are saved within ./comparisons/
