...
class RandomTest(BaseTest):
    ...
    def vanilla_supervise(self):
        ...
        for t in range(self.TRIALS):
            ...
            value_iter_r, classic_il_r, acc, loss, ___ = self.supervise_trial(mdp, dt)
    ...
    def vanilla_dagger(self):
        ...
        for t in range(self.TRIALS):
            ...
            if self.DEPTH == -1:
                ...
                dt = DecisionTreeClassifier(max_depth=self.DEPTH)
            r, acc, loss, ___ = self.dagger_trial(mdp, dt)
    ...
    for filename in sorted(os.listdir('scenarios_sparse2d/')):
        for i in range(len(params)):
            if filename.endswith('.p'):
                ...
                test = RandomTest('random2d_deter_sparse_linear/' + filename, 40, ITER, TRIALS, SAMP)
