...
dt_comparison_names = [#'compilations/svm_naive_sweep_20ld/supervise_.3eps.npy',
        'compilations2/fixed_sweep_10ld/supervise_.4eps.npy',
        'compilations2/fixed_sweep_10ld/supervise_.5eps.npy',
        'compilations2/fixed_sweep_10ld/supervise_.6eps.npy',
        'compilations2/fixed_sweep_10ld/supervise_.7eps.npy',
        'compilations2/fixed_sweep_10ld/supervise_.8eps.npy',
